...
with open('revisedrouteNov2019CSV.csv') as csv_file:
    with open('RevisedNetworkChainagesNov.csv', mode='w') as chainage_file:
        ...
        for row in csv_reader:
            ...
            if line_count == 0:
                ...
                if row[3] >= 2000:
                    ...
                    chainages=np.arange(start=0, stop=float(round(float(row[3]),2)), step=200, dtype=float)
